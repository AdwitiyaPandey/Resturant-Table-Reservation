...
def login_successful():
    ...
    root=Toplevel() # Create a new window
    ...
    # def selected():
    #     if selected_role == "Male":
    #         print("Male")
    #     elif selected_role == "Female":
    #         print("Female")
    #     else:
    #         print("Other")
    # selected()
...
Radiobutton(root, text="Male", variable=role_var, value="User").place(x=30, y=130)
